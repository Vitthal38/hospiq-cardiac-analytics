...
3. **Prioritise the cardio-renal patient.** CKD is the dominant comorbidity multiplier — flag CKD + hypertension arrivals for intensified monitoring.
   *Quantified impact: CKD patients (1,550 admissions, 9.8% of all admissions) die at 14.39% (223 deaths) — roughly 2.1x the 7.01% hospital-wide mortality rate.*
4. **Align staffing to the emergency-heavy, seasonally-peaked demand.**
   *Quantified impact: HFrEF patients make up 2,421 admissions (15.4% of the 15,757 total) with 20.78% mortality (503 deaths, 45.5% of all hospital deaths) — a large, high-risk cohort whose care demands should shape capacity and staffing decisions alongside raw emergency-route volume.*
